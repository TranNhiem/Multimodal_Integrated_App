...
def train(
    # model/data params
    base_model: str = "bigscience/bloomz-1b1", #"facebook/opt-350m",  # the only required argument
    ...
    output_dir: str = "./lora-alpaca_BlOOMZ_1B1/",
    ...
    wandb_run_name: str = "Instruction_Finetune_BLOOM_1B1_LORA",
