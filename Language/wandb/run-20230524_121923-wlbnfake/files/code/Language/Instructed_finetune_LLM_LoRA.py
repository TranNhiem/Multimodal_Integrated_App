...
def train(
    # model/data params
    base_model: str = "facebook/opt-350m",  # the only required argument
    cache_dir: str = "/media/rick/f7a9be3d-25cd-45d6-b503-7cb8bd32dbd5/pretrained_weights/OPT/",
    data_path: str = "/home/rick/Integrated_APP/Multimodal_Integrated_App/Language/data/alpaca_52k_instruction_cleaned.json",
    ...
    lora_target_modules: List[str] = TRANSFORMERS_MODELS_TO_LORA_TARGET_MODULES_MAPPING["opt"],
    # llm hyperparams
    ...
    wandb_run_name: str = "Instruction_Finetune_OPT_350m_LORA",
